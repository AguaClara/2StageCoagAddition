...
Two different trials with different humic acid concentration were compared here, parameters other than that were all same. As shown, when there was humic acid in the suspension, the effluent turbidity went down and reached a steady level more slowly. floc blanket formation was slower,  and the lowest effluent turbidity was higher. Both observation suggested a decrease in particle removal efficiency.
