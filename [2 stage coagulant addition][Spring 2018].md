...
In general, it was deduced that with the current design of system, when the turbidity of water entering the system was relatively low, more coagulant was needed to reach the target effluent turbidity. The target effluent turbidity of this experiment was no more than 3 NTU, win order to comply with the standard AguaClara system.
